...
$ git clone -b BSP-${META_RZG2_VERSION} https://github.com/renesas-rz/meta-rzg2.git
$ [[ ${META_RZG2_VERSION} != 1.0.0 ]] || git -C meta-rzg2 cherry-pick 79dbcd79ed4e1192c408a60a17c70b14c6d0715e
```
